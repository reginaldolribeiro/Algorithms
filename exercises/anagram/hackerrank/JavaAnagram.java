...
//        String b = "bbaaa";
        ...
        System.out.println( (isAnagram3(a, b)) ? "Anagrams" : "Not Anagrams" );
        System.out.println( (isAnagram4(a, b)) ? "Anagrams" : "Not Anagrams" );
    }
...
//        String b = scan.next();
    ...
    /**
     * Checks if two strings are anagrams in the most efficient way.
     *
     * Big O Notation:
     *   Time complexity: O(n), where n is the length of the strings.
     *   Space complexity: O(1), due to the fixed size of the charFrequencies array (26).
     *
     * 1. Converts both strings to lowercase for case-insensitive comparison.
     * 2. Uses an integer array of size 26 to count character frequencies:
     *    - Increments for characters in `a`.
     *    - Decrements for characters in `b`.
     * 3. Verifies that all counts are zero, indicating an anagram.
     *
